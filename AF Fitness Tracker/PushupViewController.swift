...
class PushupViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate {
    
    //MARK: Properties
    @IBOutlet weak var pushupsInput: UITextField!
    ...
    override func viewDidLoad() {
        ...
        self.pushupsInput.delegate = self
    ...
    func inputToolbarDonePressed() {
        pushupsInput.resignFirstResponder()
    }
    ...
    func updateTime() {
        if secondsLeft > 0 {
            ...
            resetTimer()
            pushupsInput.becomeFirstResponder()
        }
    }
